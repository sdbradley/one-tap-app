...
export function onUpdate(cb) {
  ...
  return () => {
    updateHandlers = updateHandlers.filter(handler => handler !== cb);
  };
}
  ...
  <Router history={hashHistory} onUpdate={update}>
    <Route path="/" component={RequireAuth}>
      ...
      <Route path="scorecard">
        ...
        <Route
          path=":partner_id/opportunities"
          component={OpportunityDetails}
        />
      </Route>

      <Route path="account/:accountId/opportunities">
        <IndexRoute component={OpportunityDetails} />
        <Route path=":opportunityId/datasheet">
