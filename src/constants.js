...
export const SITE_ROOT = (window.location.hostname === 'localhost') ? 'http://localhost:3100' : 'https://www.foundationsdigital.com';
export const APP_ROOT = `${SITE_ROOT}/app/#/`;
export const API_ROOT = (window.location.hostname === 'localhost') ? 'http://localhost:3101' : `https://${window.location.hostname}`;
